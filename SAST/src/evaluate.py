...
test_parse_files=args.test_parse_files.split(',')
...
if args.combine_test_files:
  def test_input_fn():
    return train_utils.get_input_fn(vocab, data_config, test_filenames, test_parse_files hparams.batch_size, num_epochs=1, shuffle=False,
                                    embedding_files=embedding_files)
