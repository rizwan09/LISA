...
def main():
    ...
    args_parser.add_argument('--self_attn', action='store_true', help='use self-attention on top of context RNN.')
    ...
    args_parser.add_argument('--partitioned', action='store_true',
    ...
    network = StackPtrNet(word_dim, num_words, char_dim, num_chars, pos_dim, num_pos, num_filters, window,
                          ...
                          grandPar=grandPar, sibling=sibling, use_gpu=use_gpu, use_self_attn=use_self_attn,
                          ...
                          position_dim=args.position_dim, partitioned=args.partitioned)
    ...
    def save_args():
        ...
        kwargs = {'train_position': args.train_position, 'use_word_emb': use_word_emb, 'use_con_rnn': use_con_rnn,
                  ...
                  'position_dim': args.position_dim, 'use_self_attn': use_self_attn,
